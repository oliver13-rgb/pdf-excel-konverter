/* =========================================================================
   ...
   eigenständige HTML-Datei: kursarchiv.html
...
const ziel = path.join(hier, "kursarchiv.html");
fs.writeFileSync(ziel,
  "<!doctype html>\n<html lang=\"de\">\n<head>\n" + kopf +
  "\n</head>\n<body>\n" + rumpf + "\n</body>\n</html>\n");

const kb = (fs.statSync(ziel).size / 1024).toFixed(0);
console.log("kursarchiv.html geschrieben — " + kb + " KB, eine Datei, ohne Abhängigkeiten.");
