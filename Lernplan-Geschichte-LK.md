# Lernplan Geschichte-LK — 1. Klausur
...
## ⚠️ Vorab: zwei Lücken, die du selbst schließen musst

1. **Die Unterrichtsfolien liegen mir hier nicht vor.** Der inhaltliche Teil unten (Teil C) ist das
...
# TEIL A — Was der Zettel über das Klausurformat sagt

## Die drei Aufgabenbereiche: 30 / 40 / 30 BE

| # | Operator | BE | Zeit (Vorschlag) | Tempus | Fazit? | Wertung? |
|---|----------|----|------------------|--------|--------|----------|
| 1 | **Zusammenfassen** | 30 | 30 min | Präsens (Vorzeitiges im **Perfekt**) | ❌ nein | ❌ **keine Wertung!!** |
| 2 | **Erläutern** (erklären **mit Beispiel**) | 40 | 60 min | Präsens | ❌ nein | ❌ nein |
| 3 | **Diskutieren / Stellung nehmen** | 30 | 45 min | Präsens | ✅ **Pflicht** | ✅ ja, eigene Position |
...
155–180 min Durchlesen: Konjunktiv I? Präsens? Fazit da? Textbelege da? Rechtschreibung
```

> Merke: **Aufgabe 2 bringt die meisten Punkte (40).** Wenn die Zeit knapp wird, darf Aufgabe 1
> kürzer ausfallen — aber Aufgabe 3 **niemals** weglassen, das Fazit ist dort Pflicht.
...
- **Keine Wertung!!** — kein „schockierend", „grausam", „zu Recht", „leider"
...
1. **Einleitungssatz (TATTE):** **T**extsorte, **A**utor, **T**itel, **T**hema/Datum, **E**ntstehungskontext/Adressat
   ...
   > Dominikaner Bartolomé de Las Casas das Vorgehen der spanischen Eroberer in der Karibik."*
2. **Hauptteil:** Text in Sinnabschnitte gliedern, jeder Abschnitt 1–3 Sätze, **in eigenen Worten**,
   mit Zeilenangabe (Z. 12–18). Gedankengang des Autors nachzeichnen, nicht die Reihenfolge stur
   abschreiben, wenn eine Umstellung klarer ist.
3. **Kein Schluss.**

**Sprachliche Bausteine (alle mit Konjunktiv I):**
> Der Autor legt dar, dass … / Er führt aus, die Eroberer **seien** … / Nach seiner Darstellung
> **handle** es sich um … / Er betont, die Indigenen **hätten** … / Abschließend stellt er fest,
> die Krone **müsse** …

### 🔧 Konjunktiv-I-Crashkurs (das ist der Punktebringer Nr. 1)

**Bildung:** Verbstamm + `-e, -est, -e, -en, -et, -en`

**Die goldene Regel:**
> Konjunktiv I nehmen. Wenn die Form **genauso aussieht wie der Indikativ** → **Konjunktiv II**.
> Wenn auch der komisch klingt → **„würde" + Infinitiv**.

| Indikativ | Konj. I | = Indikativ? | In der Klausur benutzen |
|-----------|---------|--------------|--------------------------|
| er sagt | er **sage** | nein | **sage** ✅ |
| sie sagen | sie sagen | **ja** | **sagten** (Konj. II) |
...
**Vorzeitigkeit** (etwas, das vor der Aussage passiert ist):
> Er berichtet, die Spanier **hätten** die Stadt **zerstört**. / Moctezuma **sei** gefangen genommen **worden**.
...
## Aufgabe 2 — Erläutern (40 BE) — die wichtigste Aufgabe
...
2. ERKLÄRUNG Warum/wie funktioniert das? (Mechanismus, Zusammenhang)
3. BELEG     a) aus der Quelle (Z. 23 f.) UND b) aus dem Kontextwissen (Jahreszahl, Ereignis, Begriff)
4. RÜCKBINDUNG  Was heißt das für die Aufgabenstellung?
```
Pro Absatz **ein** Aspekt. Bei 40 BE sind **4–6 solcher Absätze** realistisch.

**Formulierungen:**
> Dies lässt sich daran verdeutlichen, dass … / Ein Beispiel hierfür ist … / Konkret zeigt sich
> dies in Z. 14 ff., wo … / Dieser Zusammenhang wird besonders deutlich an … / Daraus folgt, dass …
...
- **2–3 Punkte** pro Seite (nicht mehr — lieber tief als breit)
- **Fazit ist Pflicht**, und die **eigene Position muss im Fazit klar erkennbar sein**
- Sein Beispielsatz: *„Es kann gesagt werden … doch es lässt sich widersprechen."*

**Aufbau (dialektisch / Sanduhr):**
```
Einleitung   Streitfrage benennen, den kontroversen Begriff/das Zitat aufgreifen
These 1–3    schwächeres Argument zuerst → stärkstes zuletzt (jeweils mit Beleg)
Antithese 1–3 jeweils: Gegenargument nennen UND entkräften
Fazit        Abwägung + klare eigene Position  ← PFLICHT
```

### 🔧 Der Ich-Ersatz (der Lehrer nennt das ausdrücklich als Tipp)
...
**Zum Entkräften:**
> Zwar lässt sich anführen, dass … **, jedoch** übersieht dieser Einwand, dass … /
> Diese Argumentation greift insofern zu kurz, als … /
> Gegen diese Sichtweise spricht, dass … /
...
- **Beide trennen und beide benennen** — das ist ein typischer LK-Zusatzpunkt.

---

# TEIL B — Der Wochenplan

> Gesamt ca. **9–10 Stunden**. Wochenende mehr, Schultage 60–90 Min.
> **Regel:** Jede Einheit endet damit, dass du das Gelernte **ohne Unterlagen** auf ein leeres
...
- [ ] **Aktiv:** Beantworte die Zettelfrage schriftlich (ca. 1/2 Seite):
      *„Warum war es so folgenreich, dass der amerikanische Kontinent ‚entdeckt' wurde?"*
...
# TEIL C — Kompaktwissen Spanische Expansion

> Mit den Folien abgleichen! Was hier steht und nicht auf den Folien war, ist nachrangig.
...
- **Ökonomisch:** Gewürze, Gold, Silber; der venezianische Levantehandel ist teuer, nach dem
  ...
  **Seeweg nach Indien**
- **Religiös:** Missionsauftrag, Kreuzzugsgedanke; **Reconquista 1492 mit Granada abgeschlossen** →
  freigewordene kriegerische Energie und ein Adel ohne Beschäftigung
- **Persönlich:** sozialer Aufstieg, Ruhm, Lehen; viele Konquistadoren sind verarmte Hidalgos

**Technische Voraussetzungen:** Karavelle (kreuzen gegen den Wind), Kompass, Astrolabium/Jakobsstab,
Portolankarten, Wiederentdeckung des Ptolemäus, Buchdruck (Verbreitung von Reiseberichten)

**Mentale Voraussetzungen:** Renaissance-Neugier, Marco Polos Reisebericht, Legenden (Eldorado,
Priesterkönig Johannes)

**Rechtliche Absicherung:** Papstbulle *Inter caetera* (1493), **Vertrag von Tordesillas 1494**
(Teilung der Welt zwischen Spanien und Portugal), **Requerimiento** (1513) — der verlesene
Unterwerfungsaufruf, der die Gewalt formal legitimieren sollte

## C2 — Verlauf: Kolumbus und Cortés

| Jahr | Ereignis |
|------|----------|
| 1492 | Kolumbus landet auf Guanahaní/Hispaniola |
| 1494 | Vertrag von Tordesillas |
| 1511 | Adventspredigt des **Antonio de Montesinos** auf Hispaniola — erste scharfe Kritik |
| **1519** | **Cortés** landet bei Veracruz, verbrennt die Schiffe, Marsch nach Tenochtitlán |
| 1519 | Treffen mit **Moctezuma II.**, dessen Gefangennahme |
| 1520 | **Noche Triste** — Spanier werden aus Tenochtitlán vertrieben |
| **13.08.1521** | **Fall Tenochtitláns** — Ende des Aztekenreichs |
| 1532/33 | **Pizarro** gegen das Inkareich, Atahualpa in Cajamarca |
| 1542 | **Leyes Nuevas** (Neue Gesetze) zum Schutz der Indigenen |
...
2. **Indigene Bündnispartner** — v. a. die **Tlaxcalteken**, Feinde der Azteken; Cortés führt
   faktisch einen Bürgerkrieg an, nicht 500 Mann gegen ein Reich
3. **Militärtechnik** — Stahlwaffen, Armbrust, Feuerwaffen, **Pferde**, Kriegshunde
4. **Kriegsführung** — Spanier töten, Azteken wollen Gefangene für Opferungen (*Blumenkriege*)
5. **Innere Schwäche** — das Aztekenreich ist ein Tributimperium; unterworfene Völker sind illoyal
6. **Malinche/Doña Marina** — Dolmetscherin und Beraterin: ohne sie keine Diplomatie, keine Bündnisse
7. *(umstritten!)* Der **Quetzalcoatl-Mythos** — Cortés als wiederkehrender Gott. In der neueren
   Forschung stark angezweifelt, vermutlich eine **nachträgliche spanische Legitimationserzählung**.
   → Genau so eine Kontroverse ist perfektes Material für Aufgabe 3!
...
- **Encomienda** (Zuteilung von Indigenen an Siedler, formal gegen Missionspflicht, faktisch
  Zwangsarbeit), **Repartimiento**, **Mita** in den Silberminen von **Potosí** (ab 1545)
- Zerstörung von Staatlichkeit, Religion, Schrift; **Christianisierung** und **Synkretismus**
...
- **Atlantischer Sklavenhandel** — entsteht als Reaktion auf den Arbeitskräftemangel nach dem
  Bevölkerungskollaps → direkte Kausalkette von der Conquista zur Sklaverei
- **Beginn der ersten Globalisierung** — erstmals ein weltumspannender Wirtschaftsraum;
  Europa rückt vom Rand ins Zentrum des Weltsystems

> **Antwort auf die Zettelfrage** („Warum war es so krass, dass Amerika entdeckt wurde?"):
> Weil erstmals in der Geschichte **zwei über Jahrtausende getrennte Menschheitshälften** dauerhaft
> in Kontakt traten — biologisch (Krankheiten, Nutzpflanzen), ökonomisch (Weltwirtschaft, Silber,
> Sklaverei), politisch (europäische Vormacht) und geistig (Infragestellung des mittelalterlichen
> Weltbildes, Beginn der Debatte über die Rechte fremder Völker → Völkerrecht).

## C4 — „Der Mönch": Bartolomé de Las Casas

- **Dominikaner**, selbst zunächst **Encomendero** auf Kuba, 1514 Bekehrung → „Apostel der Indios"
- Hauptwerk: **„Brevísima relación de la destrucción de las Indias"** (verfasst 1542, gedruckt 1552)
  = *„Kurzgefasster Bericht von der Verwüstung der Westindischen Länder"*
  → **Adressat: der spanische Hof / Thronfolger Philipp** — es ist eine **Anklage- und
  Appellschrift**, kein neutraler Bericht! (Wichtig für die Quellenkritik in Aufgabe 1/2)
- Erreicht die **Leyes Nuevas 1542**
- **Disput von Valladolid 1550/51** gegen **Juan Ginés de Sepúlveda**:
...
## C5 — ⭐ Urs Bitterli: Typologie der Kulturbegegnung

**Das ist der Theorie-Baustein für Aufgabe 2 — auswendig können, mit je einem Beispiel!**

| Kategorie | Merkmale | Beispiel |
|-----------|----------|----------|
| **Kulturberührung** | erster, punktueller, kurzer Kontakt; Ausgang offen; wechselseitige Neugier und Fremdheit | Landung des Kolumbus 1492; erste Begegnung Cortés–Gesandte Moctezumas |
| **Kulturzusammenstoß** | gewaltsame Konfrontation; die technisch/militärisch überlegene Seite unterwirft oder vernichtet die andere | **Die Conquista**: Fall Tenochtitláns 1521, Eroberung des Inkareichs |
| **Kulturbeziehung** | längerfristiger, geregelter, weitgehend friedlicher Austausch — meist zwischen etwa **gleich starken** Partnern, oft Handel | europäisch-chinesischer/japanischer Handel; Faktoreien an der westafrikanischen Küste |
| **Kulturverflechtung** | dauerhafte Verschmelzung, aus der etwas **Neues** entsteht | Mestizengesellschaften Lateinamerikas; religiöser Synkretismus (Virgen de Guadalupe) |

**Wichtig für ein gutes Urteil (LK-Niveau):** Die Kategorien sind **Idealtypen**, keine starren
Schubladen. Die Conquista ist primär **Kulturzusammenstoß**, geht aber aus einer **Kulturberührung**
...
- **Debatte „War die Conquista ein Völkermord?"** — Argumente: gewaltiger Bevölkerungsverlust,
  ...
  **unbeabsichtigte** Seuchen zurück, es fehlt die planmäßige Vernichtungsabsicht; der
  Völkermord-Begriff (1948) ist ein **anachronistischer** Maßstab.
  → Hier **Sachurteil und Werturteil sauber trennen!**

---

# TEIL D — Selbsttest (Donnerstag, ohne Unterlagen)
...
# TEIL E — Die 6 Regeln für den Klausurtag
...
6. **Zeit einhalten** — lieber alle drei Aufgaben ordentlich als zwei perfekt und eine gar nicht.
